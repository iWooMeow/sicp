passphrase = "3604213a3953387d79893b4bde4bf4c213d8c26d3da62a9f07eb79d"
...
def balanced(m):
    ...
    if is_planet(m):
        ...
        return (
            ...
            and total_weight(end(left(m))) * length(left(m))
...
def has_path(t, word):
    ...
    if len(word) == 1:
        ...
        return label(t) == word[0] and True in [
            has_path(b, word[1:]) for b in branches(t)
        ]
...
def check_par():
    ...
    True
    """
    r1 = interval(0.8, 1.5)  # Replace this line!
    r2 = interval(1.3, 5.1)  # Replace this line!
    return r1, r2
